...
Set oUcase=readExcelWrite2Dictionary(Local_win_path&"COSTestData.xlsx","SAP_Win_DisplayOrder","TC_1")
Call Display(oUcase("Orderno"),oUcase("PoNumber"),oUcase("Shiptoparty"))
Call CloseSAP()
