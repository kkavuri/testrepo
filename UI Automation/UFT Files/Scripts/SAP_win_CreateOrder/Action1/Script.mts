...
Call CreateSalesOrder(oUcase("Ordertype"),oUcase("salesorg"),oUcase("distributionch"),oUcase("division"),oUcase("soldtoparty"),oUcase("shiptoparty"),oUcase("Po_number"),oUcase("material"),oUcase("qty"),oUcase("rowno"))
Call CloseSAP()
